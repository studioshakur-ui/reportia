...
// Disattiva eventuali Service Worker (evita schermo nero su iOS quando la cache è corrotta)
if ("serviceWorker" in navigator) {
  navigator.serviceWorker.getRegistrations().then((regs) => regs.forEach((r) => r.unregister()));
}

export default function App() {
  // ---- Stato locale persistito (localStorage) ----
  ...
  useEffect(() => {
    (async () => {
      ...
      // TODO: sostituire con check reale su Supabase (assegnazioni della giornata)
      setIsAssigned(false);
      setBooted(true);
    })();
  }, []);

  // ---- Persistenza quando i dati cambiano ----
